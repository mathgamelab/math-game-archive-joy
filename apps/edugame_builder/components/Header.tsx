...
const Header: React.FC<HeaderProps> = ({ currentStep, onSettingsClick }) => {
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="px-3 py-2 text-sm font-medium rounded-lg flex items-center gap-2 transition shadow-sm hover:bg-slate-100"
            title="설정"
          >
